...
# source(paste0(dir,"Michelle/ChIP-SeqLibraryOfFunctions/ChIP-SeqLibraryOfFunctions_originalcompletecases2.R"))
# source(paste0(dir,"Michelle/ChIP-SeqLibraryOfFunctions/ChIP-SeqLibraryOfFunctions_original.R"))
...
if(genelist.name=="all"){
     ...
     if(genelist.name=="stable.10M"){
          ...
          plot_results_dir = paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/normalizedBED_",bin.size,"bp_bin/outputdir/stable.10M/")
          genes <- read.table(paste0(dir,"Michelle/MethylationData/methylatedGeneLists/new/age_stable_methylated_genes_at_10months_new_annotation.txt"))
          h3k4.maxbreak=1500
          h3k27.maxbreak=250
          dnmt.maxbreak=50
          ezh2.maxbreak=120
     ...
     if(genelist.name=="intermediate.10M"){
          ...
          plot_results_dir = paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/normalizedBED_",bin.size,"bp_bin/outputdir/intermediate.10M/")
          genes <- read.table(paste0(dir,"Michelle/MethylationData/methylatedGeneLists/new/age_intermediate_methylated_genes_at_10months_new_annotation.txt"))
          h3k4.maxbreak=1500
          h3k27.maxbreak=250
          dnmt.maxbreak=50
          ezh2.maxbreak=120
     ...
     if(genelist.name=="stable.10M.new"){
          ...
          plot_results_dir = paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/unnormalizedBED_",bin.size,"bp_bin/outputdir/stable.10M.new/")
          genes <- read.table(paste0(dir,"Michelle/MethylationData/methylatedGeneLists/new/age_stable_methylated_genes_at_10months_new_cutoff.txt"))
          h3k4.maxbreak=1500
          h3k27.maxbreak=250
          dnmt.maxbreak=50
          ezh2.maxbreak=120
     ...
     if(genelist.name=="intermediate.10M.new"){
          ...
          plot_results_dir = paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/normalizedBED_",bin.size,"bp_bin/outputdir/intermediate.10M.new/")
          genes <- read.table(paste0(dir,"Michelle/MethylationData/methylatedGeneLists/new/age_intermediate_methylated_genes_at_10months_new_cutoff.txt"))
          h3k4.maxbreak=1500
          h3k27.maxbreak=250
          dnmt.maxbreak=50
          ezh2.maxbreak=120
     ...
     if(genelist.name==" highly.expressed"){
          ...
          plot_results_dir = paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/normalizedBED_",bin.size,"bp_bin/outputdir/",genelist.name,"/")
          plot_results_dir
...
coverage_files_dir <- paste0(dir,"Michelle/BED_files/Coverage_TSS_",bin.size,"bp_bin/unnormalizedBED_",bin.size,"bp_bin/")
coverage_files_dir
...
if(version=="hg19-UCSC"){
     hg19ucsc <- fun.genelist.info_allGenes_biomaRt(version="hg19-UCSC", 
                                                    ...
                                                    hg19UCSCGeneAnnotationsPath=paste0(dir,"/Michelle/Required_Files/Annotations/hg19Data/"))
...
# # plot.Directory=dir,"Michelle/Analysis/chipseq_plot/updated_code_3.19.2015/"
# plot.Directory=paste0(dir,"Michelle/BED_files/Coverage_TSS_200bp_bin/normalizedBED_200bp_bin/outputdir/", genelist.name)
