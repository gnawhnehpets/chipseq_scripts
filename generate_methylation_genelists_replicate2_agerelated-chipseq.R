...
# load(file=paste0(system.dir, "/Michelle/Robjects/michelle_new-annotation_old.RData")) #rep2
...
dir.create(newdir)
newdir <- paste0(system.dir, "Michelle/MethylationData/methylatedGeneLists/", date, "/rep2_agerelated/")
newdir
dir.create(newdir)
setwd(newdir)
...
genelist.name1="age-related.05.hypermethylation_6M_rep2_sb"
...
genelist.name2="csc-related.05.hypermethylation_6M_rep2_sb"
...
genelist.name1="age-related.05.hypermethylation_10M_rep2_sb"
...
genelist.name2="csc-related.05.hypermethylation_10M_rep2_sb"
...
genelist.name1="age-related.05.hypermethylation_15M_rep2_sb"
...
genelist.name2="csc-related.05.hypermethylation_15M_rep2_sb"
...
#####
print("checkpoint3")
genelist.name1="age-related.2.true.hypermethylation_6M_rep2_sb"
age.hypermethylation.6M <- tss[which((tss$c6-tss$c1)>=.4 & abs(tss$csc6-tss$csc1)>=.05 & abs(tss$csc6-tss$csc1)<=.2),]
if(dim(age.hypermethylation.6M)[1]>0){
     age.hypermethylation.6M.genes <- get.genelist(age.hypermethylation.6M, genelist.nam=genelist.name1)
}
head(age.hypermethylation.6M)
genelist.name2="csc-related.2.true.hypermethylation_6M_rep2_sb"
...
#####
print("checkpoint3")
genelist.name1="age-related.2.true.hypermethylation_10M_rep2_sb"
...
head(age.hypermethylation.10M)
genelist.name2="csc-related.2.true.hypermethylation_10M_rep2_sb"
...
#####
print("checkpoint4")
genelist.name1="age-related.2.true.hypermethylation_15M_rep2_sb"
age.hypermethylation.15M <- tss[which((tss$c15-tss$c1)>=.4 & abs(tss$csc15-tss$csc1)>=.05 & abs(tss$csc15-tss$csc1)<=.2),]
age.hypermethylation.15M.genes <- get.genelist(age.hypermethylation.15M, genelist.nam=genelist.name1)
head(age.hypermethylation.15M)
genelist.name2="csc-related.2.true.hypermethylation_15M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.hypermethylation_6M_rep2_sb"
# age.hypermethylation.6M <- tss[which((tss$c6-tss$c1)>=.4 & abs(tss$csc6-tss$csc1)<=.2),]
# if(dim(age.hypermethylation.6M)[1]>0){
#      age.hypermethylation.6M.genes <- get.genelist(age.hypermethylation.6M, genelist.nam=genelist.name1)
# }
# head(age.hypermethylation.6M)
# genelist.name2="csc-related.2.hypermethylation_6M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.hypermethylation_10M_rep2_sb"
# age.hypermethylation.10M <- tss[which((tss$c10-tss$c1)>=.4 & abs(tss$csc10-tss$csc1)<=.2),]
# if(dim(age.hypermethylation.10M)[1]>0){
#      age.hypermethylation.10M.genes <- get.genelist(age.hypermethylation.10M, genelist.nam=genelist.name1)
# }
# head(age.hypermethylation.10M)
# genelist.name2="csc-related.2.hypermethylation_10M_rep2_sb"
...
# #####
# print("checkpoint4")
# genelist.name1="age-related.2.hypermethylation_15M_rep2_sb"
# age.hypermethylation.15M <- tss[which((tss$c15-tss$c1)>=.4 & abs(tss$csc15-tss$csc1)<=.2),]
# age.hypermethylation.15M.genes <- get.genelist(age.hypermethylation.15M, genelist.nam=genelist.name1)
# head(age.hypermethylation.15M)
# genelist.name2="csc-related.2.hypermethylation_15M_rep2_sb"
...
stable <- read.table("~/.gvfs/onc-analysis$ on onc-cbio2.win.ad.jhu.edu/users/shwang26/Michelle/MethylationData/methylatedGeneLists/2015-06-01/rep2_agerelated/TSS_age-related.05.hypermethylation_10M_rep2_sb_beta.values.txt")
intermediate <- read.table("~/.gvfs/onc-analysis$ on onc-cbio2.win.ad.jhu.edu/users/shwang26/Michelle/MethylationData/methylatedGeneLists/2015-06-01/rep2_agerelated/TSS_age-related.2.true.hypermethylation_10M_rep2_sb_beta.values.txt")
head(stable)
...
stable <- read.table("~/.gvfs/onc-analysis$ on onc-cbio2.win.ad.jhu.edu/users/shwang26/Michelle/MethylationData/methylatedGeneLists/2015-06-01/rep2_agerelated/TSS_csc-related.05.hypermethylation_10M_rep2_sb_beta.values.txt")
intermediate <- read.table("~/.gvfs/onc-analysis$ on onc-cbio2.win.ad.jhu.edu/users/shwang26/Michelle/MethylationData/methylatedGeneLists/2015-06-01/rep2_agerelated/TSS_csc-related.2.true.hypermethylation_10M_rep2_sb_beta.values.txt")
head(stable)
intersect(rownames(stable), rownames(intermediate))
sort(intersect(unlist(strsplit(as.matrix(stable$Gene),";")), unlist(strsplit(as.matrix(intermediate$Gene),";"))))
...
genelist.name1="age-related.05.hypomethylation_6M_rep2_sb"
...
genelist.name2="csc-related.05.hypomethylation_6M_rep2_sb"
...
genelist.name1="age-related.05.hypomethylation_10M_rep2_sb"
...
genelist.name2="csc-related.05.hypomethylation_10M_rep2_sb"
...
genelist.name1="age-related.05.hypomethylation_15M_rep2_sb"
...
genelist.name2="csc-related.05.hypomethylation_15M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.true.hypomethylation_6M_rep2_sb"
# age.hypomethylation.6M <- tss[which((tss$c6-tss$c1)<=-.4 & abs(tss$csc6-tss$csc1)>=.05 & abs(tss$csc6-tss$csc1)<=.2),]
# if(dim(age.hypomethylation.6M)[1]>0){
#      age.hypomethylation.6M.genes <- get.genelist(age.hypomethylation.6M, genelist.nam=genelist.name1)
# }
# head(age.hypomethylation.6M)
# genelist.name2="csc-related.2.true.hypomethylation_6M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.true.hypomethylation_10M_rep2_sb"
...
# }
# head(age.hypomethylation.10M)
# genelist.name2="csc-related.2.true.hypomethylation_10M_rep2_sb"
...
#####
print("checkpoint4")
genelist.name1="age-related.2.true.hypomethylation_15M_rep2_sb"
age.hypomethylation.15M <- tss[which((tss$c15-tss$c1)<=-.4 & abs(tss$csc15-tss$csc1)>=.05 & abs(tss$csc15-tss$csc1)<=.2),]
age.hypomethylation.15M.genes <- get.genelist(age.hypomethylation.15M, genelist.nam=genelist.name1)
head(age.hypomethylation.15M)
genelist.name2="csc-related.2.true.hypomethylation_15M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.hypomethylation_6M_rep2_sb"
# age.hypomethylation.6M <- tss[which((tss$c6-tss$c1)<=-.4 & abs(tss$csc6-tss$csc1)<=.2),]
# if(dim(age.hypomethylation.6M)[1]>0){
#      age.hypomethylation.6M.genes <- get.genelist(age.hypomethylation.6M, genelist.nam=genelist.name1)
# }
# head(age.hypomethylation.6M)
# genelist.name2="csc-related.2.hypomethylation_6M_rep2_sb"
...
# #####
# print("checkpoint3")
# genelist.name1="age-related.2.hypomethylation_10M_rep2_sb"
# age.hypomethylation.10M <- tss[which((tss$c10-tss$c1)<=-.4 & abs(tss$csc10-tss$csc1)<=.2),]
# if(dim(age.hypomethylation.10M)[1]>0){
#      age.hypomethylation.10M.genes <- get.genelist(age.hypomethylation.10M, genelist.nam=genelist.name1)
# }
# head(age.hypomethylation.10M)
# genelist.name2="csc-related.2.hypomethylation_10M_rep2_sb"
...
# #####
# print("checkpoint4")
# genelist.name1="age-related.2.hypomethylation_15M_rep2_sb"
# age.hypomethylation.15M <- tss[which((tss$c15-tss$c1)<=-.4 & abs(tss$csc15-tss$csc1)<=.2),]
# age.hypomethylation.15M.genes <- get.genelist(age.hypomethylation.15M, genelist.nam=genelist.name1)
# head(age.hypomethylation.15M)
# genelist.name2="csc-related.2.hypomethylation_15M_rep2_sb"
