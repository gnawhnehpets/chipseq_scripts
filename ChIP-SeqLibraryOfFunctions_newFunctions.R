...
#                cov.chr <- do.call(cbind, lapply(1:nrow(genelist.info.u), FUN=function(x){
...
#                     colnames(gene.coverage)<-genelist.info[[u]]$Gene[x]
#                     #                print(genelist.info[[u]]$Gene[x])
#                     head(gene.coverage)
