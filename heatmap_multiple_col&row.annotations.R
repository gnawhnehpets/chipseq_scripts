...
row_annotation <- matrix(sample(c("red", "blue", "green"), 50, replace=T), nrow=5)
rownames(row_annotation) <- c("Variable Y1", "Variable Y2", "Variable Y3", "Y4", "Y5")
row_annotation
dim(row_annotation)
class(row_annotation)
dim(row.annotation.color)
class(row.annotation.color)
head(row_annotation)
